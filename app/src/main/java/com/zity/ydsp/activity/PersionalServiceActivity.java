...
public class PersionalServiceActivity extends BaseActivity {
    ...
    private ArrayList<Fragment> fragmentList = new ArrayList<Fragment>() {{
        add(new PersionalServiceThemFragment());
        add(new PersionalServiceClassFragment());
    }};

    @Override
    protected int getLayout() {
        return R.layout.activity_persional_service;
    }
