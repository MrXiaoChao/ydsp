...
import com.zity.ydsp.bean.JsonBean;
import com.zity.ydsp.widegt.GetJsonDataUtil;
...
//                    Toast.makeText(ChangePersonalInfoActivity.this,"解析数据失败",Toast.LENGTH_SHORT).show();
    ...
    protected int getLayout() {
        return R.layout.activity_changaddress;
    }

    @Override
    protected void initData() {
        mHandler.sendEmptyMessage(MSG_LOAD_DATA);
        tvTooltarTitle.setText("修改地址");
    ...
    @OnClick({R.id.iv_toolbar_back, R.id.tv_right_save, R.id.rl_address})
