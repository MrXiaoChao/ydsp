...
import com.zity.ydsp.fragment.AllCaseFragment;
import com.zity.ydsp.fragment.CheckCaseFragment;
import com.zity.ydsp.fragment.CorporationLoginFragment;
import com.zity.ydsp.fragment.FinishCaseFragment;
import com.zity.ydsp.fragment.NoSubmitCaseFragment;
import com.zity.ydsp.fragment.PersonallyLoginFragment;
import com.zity.ydsp.fragment.RejectCaseFragment;
...
public class MyCaseActivity extends BaseActivity {
    ...
    private ArrayList<Fragment> fragmentList = new ArrayList<Fragment>() {{
        add(new AllCaseFragment());
        add(new NoSubmitCaseFragment());
        add(new CheckCaseFragment());
        add(new RejectCaseFragment());
        add(new FinishCaseFragment());
    }};
